...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=STRING   Check a specific file",
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->nohelp_given)
    write_into_file(outfile, "nohelp", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "Vf:b:d:h", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* Check a specific file.  */
          ...
          break;
        case 'b':	/* Check inside file, line by line.  */
          ...
          break;
        case 'd':	/* Check one specific directory.  */
          ...
          break;
        case 'h':	/* A list of all avaliable commands.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->nohelp_given),
              &(local_args_info.nohelp_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "nohelp", 'h',
              additional_error))
            goto failure;
